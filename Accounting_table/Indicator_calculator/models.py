...
class Service(models.Model):
    ...
    actual_indicator_IUC = models.DecimalField(max_digits=5, decimal_places=2)
    # list_of_departments
...
class Department(models.Model):
    ...
    department_indicator = models.DecimalField(max_digits=4, decimal_places=1)
...
class Indicator(models.Model):
    ...
    actual_indicator = models.DecimalField(max_digits=4, decimal_places=1)
